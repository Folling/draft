...
\pnum
\mandates
\tcode{u.base()} is well-formed and convertible to \tcode{Iterator}.

\pnum
\effects
Initializes \tcode{current} with \tcode{u.base()}.
\end{itemdescr}
...
\pnum
\mandates
\tcode{u.base()} is well-formed and \tcode{is_assignable_v<Iterator\&, U>} is \tcode{true}.
