...
\begin{note}
A glvalue can have complete or incomplete non-\tcode{void} type.
...
whose scope is the \grammarterm{lambda-expression}'s
...
\begin{note}
Such expressions can be used in \tcode{new}
